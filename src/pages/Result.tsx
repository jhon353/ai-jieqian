    ...
    if (navigator.share && sign) {
      try {
        await navigator.share({
          title: 'AI 解签结果',
          text: `我在 ${sign.temple_name || '某寺庙'} 抽到了签，AI 解读如下：${sign.interpretation.substring(0, 100)}...`,
        })
      } catch (err) {
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-lg mx-auto px-4 py-6">
          <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-4">AI 解读</h2>
          ...
          <div className="flex gap-3 mt-6">
            <button
              onClick={handleShare}
              className="flex-1 bg-blue-600 text-white py-3 rounded-xl font-medium hover:bg-blue-700 transition active:scale-[0.98]"
            >
      ...
      <div className="max-w-lg mx-auto px-4 py-6">
        {sign ? (
          <>
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6">
              {sign.temple_name && (
                <p className="text-sm text-blue-600 font-medium mb-4">{sign.temple_name}</p>
              )}
